...
var forbiddenParamSchema = lazySchema(() => zodSchema(object$1({ ruleId: string() })));
var _a8$1;
var _b8;
...
var gatewayVideoStartResponseSchema = object$1({
	operation: unknown(),
	warnings: array$1(gatewayVideoWarningSchema).nullish(),
	providerMetadata: record(string(), providerMetadataEntrySchema2).nullish()
});
var gatewayVideoStatusResponseSchema = discriminatedUnion("status", [
	object$1({
...
var providerMetadataEntrySchema3 = object$1({}).catchall(unknown());
...
var gatewaySpeechResponseSchema = object$1({
	audio: string(),
	warnings: array$1(gatewaySpeechWarningSchema).optional(),
...
var providerMetadataEntrySchema4 = object$1({}).catchall(unknown());
...
var gatewayTranscriptionResponseSchema = object$1({
	text: string(),
...
var exaSearchInputSchema = lazySchema(() => zodSchema(object$1({
	...
	include_domains: array$1(string()).optional().describe("Only return results from these domains."),
	exclude_domains: array$1(string()).optional().describe("Exclude results from these domains."),
	...
	contents: object$1({
		text: union([boolean(), object$1({
			...
			include_sections: array$1(_enum([
				"header",
				"navigation",
				"banner",
				"body",
			...
			exclude_sections: array$1(_enum([
				"header",
				"navigation",
				"banner",
				"body",
...
var exaSearchOutputSchema = lazySchema(() => zodSchema(union([object$1({
	requestId: string(),
	...
	results: array$1(object$1({
		...
		extras: object$1({
			links: array$1(string()).optional(),
			imageLinks: array$1(string()).optional()
		}).optional()
	})),
...
var parallelSearchInputSchema = lazySchema(() => zodSchema(object$1({
...
var parallelSearchOutputSchema = lazySchema(() => zodSchema(union([object$1({
	searchId: string(),
	results: array$1(object$1({
		url: string(),
		title: string(),
...
var perplexitySearchInputSchema = lazySchema(() => zodSchema(object$1({
...
var perplexitySearchOutputSchema = lazySchema(() => zodSchema(union([object$1({
	results: array$1(object$1({
		title: string(),
		url: string(),
		snippet: string(),
...
var VERSION$1 = "4.0.44";
var AI_GATEWAY_PROTOCOL_VERSION = "0.0.1";
var gatewayClientSecretResponseSchema = object$1({
	token: string(),
