...
var gatewayVideoStartResponseSchema = z11.object({
  operation: z11.unknown(),
  warnings: z11.array(gatewayVideoWarningSchema).nullish(),
  providerMetadata: z11.record(z11.string(), providerMetadataEntrySchema2).nullish()
});
var gatewayVideoStatusResponseSchema = z11.discriminatedUnion("status", [
  z11.object({
    status: z11.literal("pending"),
    warnings: z11.array(gatewayVideoWarningSchema).nullish(),
    providerMetadata: z11.record(z11.string(), providerMetadataEntrySchema2).nullish()
  }),
  z11.object({
  ...
  z11.object({
    status: z11.literal("error"),
    error: z11.string(),
    providerMetadata: z11.record(z11.string(), providerMetadataEntrySchema2).nullish()
  }),
  z11.object({
    status: z11.literal("cancelled"),
    providerMetadata: z11.record(z11.string(), providerMetadataEntrySchema2).nullish()
  })
]);
